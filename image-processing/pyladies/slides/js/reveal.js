...
(function( root, factory ) {
	...
	var SLIDES_SELECTOR = '.slides section',
        ...
        // Background is for ALL slides, except for overview mode
	...
	function start() {
		...
		setupIframeScrollPrevention( false );

		// Resets all vertical slides so that only the first is visible
		resetVerticalSlides( true );
	...
	function setupPDF() {
		...
		injectStyleSheet( '.reveal section>img, .reveal section>video {max-width: '+ slideWidth +'px; max-height:'+ slideHeight +'px}' );
			...
			if( background.hasAttribute( 'data-loaded' ) === false ) {
				...
				// Iframes
					...
					var iframe = document.createElement( 'iframe' );
                        ...
                        iframe.style.height = '100%';//'200%';
						iframe.style.maxHeight = '100%';//'200%';
