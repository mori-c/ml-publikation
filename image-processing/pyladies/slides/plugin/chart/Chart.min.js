	...
	return ! function e(t, i, a) {
		...
		, function () {
			...
			var t = this
				, e = t.Chart
				, i = e.helpers = {}
				, a = i.each = function (t, e, i, a) {
					var s = Array.prototype.slice.call(arguments, 3);
					if (t)
						if (t.length === +t.length) {
							var o;
							if (a)
								for (o = t.length - 1; o >= 0; o--) e.apply(i, [t[o], o].concat(s));
							else
								for (o = 0; o < t.length; o++) e.apply(i, [t[o], o].concat(s))
						} else
							for (var n in t) e.apply(i, [t[n], n].concat(s))
				}
					...
					return i.each(Array.prototype.slice.call(arguments, 1), function (t) {
						i.each(t, function (s, o) {
							if (t.hasOwnProperty(o))
								if ("scales" === o) a[o] = i.scaleMerge(a.hasOwnProperty(o) ? a[o] : {}, s);
								else if ("scale" === o) a[o] = i.configMerge(a.hasOwnProperty(o) ? a[o] : {}, e.scaleService.getScaleDefaults(s.type), s);
							else if (a.hasOwnProperty(o) && i.isArray(a[o]) && i.isArray(s)) {
								var n = a[o];
				...
				, u = (i.bindEvents = function (t, e, i) {
					...
					var e, i = document.defaultView.getComputedStyle(t)["max-width"]
						, a = document.defaultView.getComputedStyle(t.parentNode)["max-width"]
						, s = null !== i && "none" !== i
						, o = null !== a && "none" !== a;
				...
				, g = i.getConstraintHeight = function (t) {
					var e, i = document.defaultView.getComputedStyle(t)["max-height"]
						, a = document.defaultView.getComputedStyle(t.parentNode)["max-height"]
						, s = null !== i && "none" !== i
						, o = null !== a && "none" !== a;
				...
				, m = (i.getMaximumWidth = function (t) {
					var e = t.parentNode
						, i = parseInt(m(e, "padding-left")) + parseInt(m(e, "padding-right"))
						, a = e.clientWidth - i
						, s = u(t);
					return void 0 !== s && (a = Math.min(a, s)), a
				}, i.getMaximumHeight = function (t) {
					var e = t.parentNode
						, i = parseInt(m(e, "padding-top")) + parseInt(m(e, "padding-bottom"))
						, a = e.clientHeight - i
						, s = g(t);
					return void 0 !== s && (a = Math.min(a, s)), a
			...
			e.elements = {}, e.Element = function (t) {
				...
				, transition: function (t) {
					return this._view || (this._view = i.clone(this._model)), this._start || this.pivot(), i.each(this._model, function (e, a) {
						...
						else "number" == typeof e && isNaN(this._view[a]) === !1 ? this._view[a] = e * t : this._view[a] = e || null;
						else;
			...
			e.types = {}, e.instances = {}, e.controllers = {}, e.Controller = function (t) {
				...
				, resize: function (t) {
					...
					var e = this.chart.canvas
						, a = i.getMaximumWidth(this.chart.canvas)
						, s = this.options.maintainAspectRatio && isNaN(this.chart.aspectRatio) === !1 && isFinite(this.chart.aspectRatio) && 0 !== this.chart.aspectRatio ? a / this.chart.aspectRatio : i.getMaximumHeight(this.chart.canvas);
				...
				, buildScales: function () {
					if (this.scales = {}, this.options.scales && (this.options.scales.xAxes && this.options.scales.xAxes.length && i.each(this.options.scales.xAxes, function (t, i) {
							var a = e.scaleService.getScaleConstructor(t.type)
								, s = new a({
									ctx: this.chart.ctx
									, options: t
									, chart: this
							...
							for (var t = 0; t < this.data.datasets.length; t++)
								if (i.isDatasetVisible(this.data.datasets[t]))
									for (var a = 0; a < this.data.datasets[t].metaData.length; a++)
										if (this.data.datasets[t].metaData[a].inRange(e.x, e.y)) return this.data.datasets[t].metaData[a]
						}.call(this);
				...
				, draw: function () {
					if (this.options.display) {
						...
						this.isHorizontal() && (t.textAlign = "left", t.textBaseline = "top", t.lineWidth = .5, t.strokeStyle = this.options.labels.fontColor, t.fillStyle = this.options.labels.fontColor, t.font = s, i.each(this.legendItems, function (i, s) {
							var o = t.measureText(i.text).width
								, n = this.options.labels.boxWidth + this.options.labels.fontSize / 2 + o;
		...
		, function () {
			...
			e.defaults.scale = {
				...
				, calculateTickRotation: function () {
					...
					this.ctx.font = t;
					var e, a, s = this.ctx.measureText(this.ticks[0]).width
				...
				, fit: function () {
					if (this.minSize = {
						...
						if (this.isHorizontal()) {
							...
							var a = this.ctx.measureText(this.ticks[0]).width
								, s = this.ctx.measureText(this.ticks[this.ticks.length - 1]).width
								, o = Math.cos(i.toRadians(this.labelRotation))
								, n = Math.sin(i.toRadians(this.labelRotation));
							...
							var r = this.maxWidth - this.minSize.width
								, h = i.longestText(this.ctx, t, this.ticks);
				...
				, draw: function (t) {
					if (this.options.display) {
						var e, a, s, o, n = 0 !== this.labelRotation
						...
						var h = i.fontString(this.options.ticks.fontSize, this.options.ticks.fontStyle, this.options.ticks.fontFamily)
							, l = Math.cos(i.toRadians(this.labelRotation))
							, c = Math.sin(i.toRadians(this.labelRotation))
							, d = this.longestLabelWidth * l;
						this.options.ticks.fontSize * c;
						if (this.isHorizontal()) {
							e = !0;
							var u = "bottom" === this.options.position ? this.top : this.bottom - 10
								, g = "bottom" === this.options.position ? this.top + 10 : this.bottom;
							a = !1, (d / 2 + this.options.ticks.autoSkipPadding) * this.ticks.length > this.width - (this.paddingLeft + this.paddingRight) && (a = 1 + Math.floor((d / 2 + this.options.ticks.autoSkipPadding) * this.ticks.length / (this.width - (this.paddingLeft + this.paddingRight)))), r || (a = !1), i.each(this.ticks, function (s, o) {
								if (!(a > 1 && o % a > 0 || void 0 === s || null === s)) {
									var r = this.getPixelForTick(o)
										, l = this.getPixelForTick(o, this.options.gridLines.offsetGridLines);
							...
							var m = "right" === this.options.position ? this.left : this.right - 5
								, f = "right" === this.options.position ? this.left + 5 : this.right;
			...
			i.defaults.global.tooltips = {
				...
				, getBody: function (t, e) {
					...
					return a.each(t, function (t) {
						var a = this._options.tooltips.callbacks.beforeLabel.call(this, t, e) || ""
							, s = this._options.tooltips.callbacks.label.call(this, t, e) || ""
							, o = this._options.tooltips.callbacks.afterLabel.call(this, t, e) || "";
						i.push(a + s + o)
					}, this), i
				}
		...
		, function () {
			...
			e.defaults.bubble = {
				...
				, update: function (t) {
					var e, a = this.getDataset().metaData
		...
		, function () {
			...
			e.defaults.line = {
				...
				, update: function (t) {
					var e, a = this.getDataset().metaDataset
		...
		, function () {
			...
			e.defaults.radar = {
				...
				, update: function (t) {
					var e, a = (this.getDataset().metaDataset, this.getDataset().metaData)
						, s = this.chart.scale;
					...
					, getPixelForValue: function (t, e, i, a) {
						if (this.isHorizontal()) {
							var s = this.width - (this.paddingLeft + this.paddingRight)
								, o = s / Math.max(this.chart.data.labels.length - (this.options.gridLines.offsetGridLines ? 0 : 1), 1)
						...
						var r = this.height - (this.paddingTop + this.paddingBottom)
							, h = r / Math.max(this.chart.data.labels.length - (this.options.gridLines.offsetGridLines ? 0 : 1), 1)
							, l = h * e + this.paddingTop;
				...
				, s = e.Scale.extend({
					determineDataLimits: function () {
						if (this.min = null, this.max = null, this.options.stacked) {
							...
							i.each(this.chart.data.datasets, function (e) {
								void 0 === t[e.type] && (t[e.type] = {
									positiveValues: []
									, negativeValues: []
								});
								var a = t[e.type].positiveValues
									, s = t[e.type].negativeValues;
					...
					, buildTicks: function () {
						...
						var e = i.niceNum(this.max - this.min, !1)
							, a = i.niceNum(e / (t - 1), !0)
							, s = Math.floor(this.min / a) * a
							, o = Math.ceil(this.max / a) * a
							, n = Math.ceil((o - s) / a);
					...
					, buildTicks: function () {
						...
						for (var t = void 0 !== this.options.ticks.min ? this.options.ticks.min : Math.pow(10, Math.floor(i.log10(this.min))); t < this.max;) {
							...
							var e = Math.floor(i.log10(t))
								, a = Math.floor(t / Math.pow(10, e)) + 1;
		...
		, function () {
			...
			var t = this
				...
				, s = e.Scale.extend({
					...
					, fit: function () {
						var t, e, a, s, o, n, r, h, l, c, d, u, g = i.min([this.height / 2 - this.options.pointLabels.fontSize - 5, this.width / 2])
							, m = this.width
							, f = 0;
						...
						if (this.options.display) {
							...
							if (i.each(this.ticks, function (e, a) {
									if (a > 0 || this.options.reverse) {
										var s = this.getDistanceFromCenterForValue(this.ticks[a])
											, o = this.yCenter - s;
										if (this.options.gridLines.display)
											if (t.strokeStyle = this.options.gridLines.color, t.lineWidth = this.options.gridLines.lineWidth, this.options.lineArc) t.beginPath(), t.arc(this.xCenter, this.yCenter, s, 0, 2 * Math.PI), t.closePath(), t.stroke();
											else {
												t.beginPath();
								...
								for (var e = this.getValueCount() - 1; e >= 0; e--) {
									...
									var o = this.chart.data.labels.length
										, n = this.chart.data.labels.length / 2
										, r = n / 2
										, h = r > e || e > o - r
										, l = e === r || e === o - r;
			...
			var e = this
				...
				, n = i.Scale.extend({
					...
					, buildTicks: function (t) {
						if (this.ticks = [], this.unitScale = 1, this.options.time.unit) this.tickUnit = this.options.time.unit || "day", this.displayFormat = this.options.time.displayFormats[this.tickUnit], this.tickRange = Math.ceil(this.lastTick.diff(this.firstTick, this.tickUnit, !0));
							...
							for (var n = 0, r = s.units[n]; n < s.units.length;) {
								if (this.unitScale = 1, a.isArray(r.steps) && Math.ceil(this.tickRange / i) < a.max(r.steps)) {
									for (var h = 0; h < r.steps.length; ++h)
										if (r.steps[h] > Math.ceil(this.tickRange / i)) {
						...
						for (var l = 0; l <= this.tickRange; ++l)
							if (l % this.unitScale === 0) this.ticks.push(this.firstTick.clone().add(l, this.tickUnit));
							else if (l === this.tickRange) {
					...
					, getPixelForValue: function (t, e, i, a) {
						var s = this.getLabelMoment(i, e)
							, o = s.diff(this.firstTick, this.tickUnit, !0)
							, n = o / this.tickRange;
						if (this.isHorizontal()) {
							var r = this.width - (this.paddingLeft + this.paddingRight)
				...
				, inRange: function (t, e) {
					...
					if (a) {
						var s = i.getAngleFromPoint(a, {
							...
							, o = a.startAngle < -.5 * Math.PI ? a.startAngle + 2 * Math.PI : a.startAngle > 1.5 * Math.PI ? a.startAngle - 2 * Math.PI : a.startAngle
							, n = a.endAngle < -.5 * Math.PI ? a.endAngle + 2 * Math.PI : a.endAngle > 1.5 * Math.PI ? a.endAngle - 2 * Math.PI : a.endAngle
							, r = s.angle >= o && s.angle <= n
			...
			e.defaults.global.elements.line = {
				...
				, draw: function () {
					...
					o.save(), this._children.length > 0 && s.fill && (o.beginPath(), i.each(this._children, function (t, e) {
						var a = i.previousItem(this._children, e)
							, n = i.nextItem(this._children, e);
